...
export const ROUTES: Route[] = [
  ...
  },
  {
    ...
    pathname: "/project/[projectId]/document-chunking-strategy",
    icon: FileTerminal,
    group: RouteGroup.Optimization,
    section: RouteSection.Main,
  },
  {
    ...
    pathname: "/project/[projectId]/table-parsing-strategy",
  ...
  },
  {
    ...
    pathname: "/project/[projectId]/retrieval-pre-post-processing-strategy",
    icon: SearchSlash,
    group: RouteGroup.Optimization,
    section: RouteSection.Main,
  },
  {
    ...
    pathname: "/project/[projectId]/memory-strategy",
  ...
  },
  {
    ...
    pathname: "/project/[projectId]/data-protection",
    icon: DatabaseBackup,
  ...
  },
  {
    ...
    pathname: "/project/[projectId]/prompt-injection-prevention",
    icon: FileScan,
    group: RouteGroup.Guardrails,
    section: RouteSection.Main,
  },
  ...
  {
    title: "Feedback",
    pathname: `/project/[projectId]/feedback`,
    icon: Send,
